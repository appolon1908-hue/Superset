...
TALISMAN_CONFIG = {
    # TLS is terminated by the trusted Codestra edge. Gunicorn intentionally
    # serves plain HTTP inside the container, including the loopback health
    # endpoint, so application-level redirects must remain disabled.
    "force_https": False,
